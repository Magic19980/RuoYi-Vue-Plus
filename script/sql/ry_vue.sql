...
(
    ...
    post_indonesian_name varchar(100) default null            comment '岗位印尼语名称',
...
insert into sys_oss_config values (1761900000000000001, 'minio', 'minioadmin', 'minioadmin', 'ruoyi', '', '127.0.0.1:9000', '', 'N', '', '1', 'Y', '', 1761000000000000103, 1761100000000000001, sysdate(), 1761100000000000001, sysdate(), null);
